  ...
  return (
    <div className="home-container">
        ...
        <div className="details-container">
          <Slide left>
            <div className="details-left">
              <h3 className="card-sub-title">Community First</h3>
              <p>
                ...
                and work on projects together. We also host workshops, speakers,
                and competitions throughout the year to help members learn new
                skills and keep up with the latest trends in software
                development. Whether you're a beginner or a seasoned pro,
                there's a place for you in the club. Join us and help us build
                the future!
              </p>
            </div>
          </Slide>
          <Slide right>
            <div className="details-right">
              <h3 className="card-sub-title">Our Services</h3>
              <p>
                ...
                design, development, testing, and deployment. From gathering and
                design, all the way to deployment we work closely with our
                clients to ensure that their needs are met and that the final
      ...
      <div className="copyright">
        <small>
          &copy; 2022 Western Developers Society. Created with ReactJS
        </small>
      </div>
    </div>
  )
