  ...
  return (
    <div className="join-container">
      ...
      <div className="exec-dev">
        ...
        <div className="director">Applications are now open for all Western students interested in joining our executive team. Directors will be hired for internal & external events, marketing, careers, and finance. In our Development portfolio we'll be hiring one community lead and 2 tech leads.<br />
        </div></div>
        <div className="dev">
        <div className="subtitle">Development Teams</div>
        <div className="devs">Applications for 4 month development teams are now open for students interested in building real world applications for WDS, other Western Clubs and local London community groups. We'll be hiring Team Leads, Developers, and Designers!</div>
        </div>
        </div>
        <div className="application"><a href='https://docs.google.com/document/d/1TXgSZM_jRahlSbkKl6KlgrWkIIl25A6WAk1_ggYnSoA/edit?usp=sharing' target="_blank" ><button>Click here to apply!</button></a></div>
